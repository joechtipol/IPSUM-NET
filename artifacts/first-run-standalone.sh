...
sudo -i -u $INSTANCE_USER bash -c "cd $HOME/devops/ipsum-net/artifacts ; ./prepare_fabric_artifacts_standalone.sh $DOMAIN_NAME $ORG_NAME_1 $ORG_NAME_2 $ORG_NAME_3 $CHANNEL_NAME $HOME/devops/ipsum-net/artifacts $REPO_URL"
...
sudo -i -u $INSTANCE_USER bash -c "cd $HOME/devops/ipsum-net/artifacts ; ./network-management-scripts/network.sh up-silent"
